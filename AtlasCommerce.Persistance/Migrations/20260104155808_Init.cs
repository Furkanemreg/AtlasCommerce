    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WebsiteBanners", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WebsiteFeature", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AboutAltSentence1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AboutAltSentence2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchasePriceExcludingTaxes = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SalePriceExcludingTaxes = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TaxRate = table.Column<int>(type: "int", nullable: false),
                    OTV = table.Column<int>(type: "int", nullable: false),
                    PurchasePriceIncludingTaxes = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SalePriceIncludingTaxes = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    StockTracking = table.Column<bool>(type: "bit", nullable: false),
                    CriticalStockLevel = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ShowInSelected = table.Column<bool>(type: "bit", nullable: false),
